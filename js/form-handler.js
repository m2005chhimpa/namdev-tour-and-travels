...
(function () {
    ...
    const GOOGLE_SHEET_URL = "https://script.google.com/macros/s/AKfycby9VzqY-cSd5Uj3mXI7RJsPpT4joZobZwrm-Fhoe0-T3rNXzoUUqoqisJrXzlBuMeQ4YA/exec";
    ...
    function attachGenericForms() {
        document.querySelectorAll("form[data-formtype]").forEach((form) => {
            ...
            // Skip the Car Booking form — car-booking.js already owns its
            // submit handling (with field validation, which this generic
            // handler doesn't do).
            if (form.id === "fleetBookingForm") return;
